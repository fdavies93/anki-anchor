...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Anki Field"))
        self.comboBox_2.setItemText(0, _translate("Form", "Text"))
        self.comboBox_2.setItemText(1, _translate("Form", "Tags"))
        self.comboBox.setItemText(0, _translate("Form", "<None>"))
        self.label_3.setText(_translate("Form", "Notion Column"))
        self.label.setText(_translate("Form", "Anki Type"))
        self.label_4.setText(_translate("Form", "Placeholder"))
        self.label_5.setText(_translate("Form", "Notion Type"))
